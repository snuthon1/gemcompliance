...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      {/* Executive Official Government Navy Sidebar Container */}
      <aside
      ...
      >
        ...
        <div className="shrink-0">
          ...
          <div className="p-3.5 border-b border-slate-800 bg-[#0B2546]/90 flex items-center justify-between">
            <Link
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-[9px] font-bold text-amber-300 uppercase tracking-wider font-mono">
                  भारत सरकार • MoPNG
                </span>
          ...
          {/* Clean Official Sub-strip */}
          <div className="px-3.5 py-1.5 bg-[#051324] border-b border-slate-800 text-[10px] text-slate-300 flex items-center justify-between font-mono">
            <span className="font-semibold text-emerald-400 flex items-center gap-1.5">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse"></span>
              {isOfficer ? 'OFFICER COMMITTEE' : 'VENDOR DESK'}
            </span>
            <span className="text-slate-400 text-[9px]">GFR 2017 &bull; CVC</span>
          </div>
        </div>
                  ...
                  return (
                    <Link
                      ...
                      className={`flex items-center space-x-2.5 px-3 py-2 rounded-md text-xs transition-colors ${
                        item.active
                          ? 'bg-[#0B2546] text-white font-bold border-l-4 border-amber-400 shadow-sm'
        ...
        <div className="shrink-0 p-3 border-t border-slate-800 bg-[#051324]">
          {user && (
            <div className="flex items-center justify-between gap-2 p-2 rounded-lg bg-[#0B2546]/80 border border-slate-700/80">
              <div className="flex items-center space-x-2.5 min-w-0">
                <div className="w-7 h-7 rounded bg-amber-400 text-[#07182D] flex items-center justify-center font-black text-xs shrink-0 shadow-2xs">
                ...
                <div className="min-w-0 flex flex-col">
                  ...
                  <span className="text-[9px] text-amber-300/90 truncate font-mono">
                    {isOfficer ? 'Authorized Officer' : (user.gstin || 'Registered Vendor')}
                  </span>
                </div>
              </div>
              ...
              <button
                ...
                className="p-1.5 text-slate-400 hover:text-rose-400 hover:bg-slate-800 rounded transition shrink-0 cursor-pointer"
                title="Sign Out"
              >
