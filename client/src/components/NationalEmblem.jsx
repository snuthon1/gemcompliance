...
export default function NationalEmblem({ className = "w-10 h-10" }) {
  return (
    <svg
      viewBox="0 0 100 120"
      className={className}
    ...
    >
      ...
      <circle cx="50" cy="90" r="5" stroke="#0B2546" strokeWidth="1.5" fill="none" />
      <circle cx="50" cy="90" r="1.5" fill="#0B2546" />
      <line x1="50" y1="85" x2="50" y2="95" stroke="#0B2546" strokeWidth="0.8" />
      <line x1="45" y1="90" x2="55" y2="90" stroke="#0B2546" strokeWidth="0.8" />
      <line x1="46.5" y1="86.5" x2="53.5" y2="93.5" stroke="#0B2546" strokeWidth="0.8" />
      <line x1="46.5" y1="93.5" x2="53.5" y2="86.5" stroke="#0B2546" strokeWidth="0.8" />
      {/* Galloping Horse on Left */}
      <path d="M34 89 C32 87, 30 88, 29 90 C31 91, 33 91, 35 91 Z" fill="#0B2546" />
      {/* Bull on Right */}
      <path d="M66 89 C68 87, 70 88, 71 90 C69 91, 67 91, 65 91 Z" fill="#0B2546" />
      {/* Base Pedestal */}
      <rect x="22" y="97" width="56" height="3" rx="1" fill="#0B2546" />
