          ...
          {tenders.map((tender) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 hover:border-indigo-500/50 hover:shadow-md cursor-pointer transition flex flex-col justify-between group"
              >
                <div>
                ...
                <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between text-xs">
                  ...
                  <div className="flex items-center space-x-3">
                    <span className="inline-flex items-center space-x-1 bg-indigo-50 text-indigo-700 font-semibold text-xs px-2.5 py-1 rounded-full border border-indigo-200/60 font-mono">
